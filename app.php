                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen" role="document">
                    <div class="modal-content">
                                            ...
                                            <div class="icon-grid row row-cols-xl-8 listPasajero" style="padding-left: 50px;padding-right: 50px;">
                                                <div class="row">
                                                    <div class="col-md-5" style="display: flex; justify-content: flex-end">
                                                        <button type="button" value="-" id="btnDecrementar" class="btn btn-sm btn-outline-secondary" >
                                                    ...
                                                    <div class="col-md-5" style="display: flex;">
                                                        <button type="button" id="btnIncrementar" class="btn btn-sm btn-outline-secondary">
                                                            <svg class="icon-64" width="100" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="modal-footer">
                            <div>
                                <button id="btnBackToHome" type="button" class="btn btn-sm btn-outline-secondary">
                            ...
                            <div class="actions">
                                <button id="btnRideBack" type="button" class="btn btn-sm btn-outline-secondary collapse">
                                    <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button id="btnRideNext" type="button" class="btn btn-sm btn-outline-secondary collapse">
                                    Next
                                    <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
