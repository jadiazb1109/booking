...
<script src="../_js/origin-service-union.js" type="module"> </script>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label" for="cmbOrigin"><strong>Origin</strong></label>
                    <div id="cmbOrigin"></div>
                </div>
                <div class="form-group">
