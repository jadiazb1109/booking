...
<script src="../_js/type-identification.js" type="module"> </script>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label" for="txtAbreviatura"><strong>Abbreviation</strong></label>
                    <input type="text" class="form-control" id="txtAbreviatura" placeholder="Enter a abbreviation">
                </div>
