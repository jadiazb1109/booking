                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="card-action">
                            <button id="btnConsultar" style="display: none;" class="text-center btn btn-primary btn-icon" title="Consultar"><i class="fa-solid fa-magnifying-glass"></i></button>
                        </div>
                    </div>
                    <br>
                </div>
...
<script src="../_js/user-rol.js" type="module"> </script>
