...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var txtOpcion = "";
    var urlApi = "../../api/v1/typeIdetification/typeIdetifications";
            ...
            if (selectId > 0) {
                ...
                $.ajax({
                    ...
                    if (resultado["state"] === 'ok') {
                        ...
                        txtAbreviatura.value = resultado["data"][0].abbreviation;
    ...
    const txtAbreviatura = document.getElementById('txtAbreviatura');
    ...
    function btnGuardarClick(e) {
        ...
        if (!txtAbreviatura.value) {
            clsGenerales_.mtdMostrarMensaje("Enter a abbreviation", "error");
            txtAbreviatura.focus();
            return;
        }

        if (txtAbreviatura.value.length > 3) {
            clsGenerales_.mtdMostrarMensaje("The abbreviation cannot have more than 3 letters", "error");
            txtAbreviatura.focus();
            return;
        }
        ...
        if (txtOpcion == "Adicionar" || txtOpcion == "Modificar") {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    ...
                    abbreviation: txtAbreviatura.value,
